<template>
  ...
  <div>
    ...
    <input type="email" placeholder="@gmail.com" class="mt-2 h-12 w-full rounded-md bg-gray-100 px-3" />
  </div>
  <div>
  ...
  <div class="grid gap-3 lg:grid-cols-2">
    <div>
      ...
      <div class="relative w-56 mt-2 bg-gray-100 rounded-lg">
        ...
        <label for="select-1" class="flex w-full cursor-pointer rounded-lg select-none border p-2 px-3 text-sm text-gray-700 ring-blue-400 peer-checked:ring">Pilih Opsi </label>
        ...
        <ul class="max-h-0 select-none flex-col overflow-hidden rounded-b-lg shadow-md transition-all duration-300 peer-checked:max-h-56 peer-checked:py-3">
          ...
          <li class="cursor-pointer px-3 py-2 text-sm text-gray-500 hover:bg-blue-500 hover:text-white">Lainnya</li>
        </ul>
      </div>
    </div>
    <div>
  ...
  <div>
    <button type="button" class="mt-5 w-full rounded-md bg-blue-600 p-2 text-center font-semibold text-white">Register</button>
  </div>
</form>
